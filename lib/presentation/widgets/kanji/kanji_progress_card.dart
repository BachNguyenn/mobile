...
class KanjiProgressCard extends StatelessWidget {
  final ModuleProgress progress;
  final int dueCount;

  const KanjiProgressCard({
    super.key,
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Chữ Hán', style: AppTypography.headingS),
            ...
            child: TweenAnimationBuilder<double>(
              ...
              builder: (context, value, _) {
                return LinearProgressIndicator(
                  ...
                  valueColor:
                      const AlwaysStoppedAnimation(AppColors.mossGreen),
                );
              },
            ),
          ),
